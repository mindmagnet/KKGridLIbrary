...
#import "KKGaleryGridViewController.h"

@interface KKGaleryGridViewController ()<UICollectionViewDelegate> {
    BOOL isAnimating;
}
@property (weak, nonatomic) IBOutlet UICollectionView *collectionView;
@property (nonatomic) NSMutableArray* numbers;
@property (nonatomic) NSMutableArray* numberWidths;
@property (nonatomic) NSMutableArray* numberHeights;@end

int num = 0;

@implementation KKGaleryGridViewController
